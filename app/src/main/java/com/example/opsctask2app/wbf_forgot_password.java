...
public class wbf_forgot_password extends AppCompatActivity {
    //Setting Variables
    Button sendEmail;
    EditText fpMail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wbf_forgot_password);
        ...
        getSupportActionBar().setTitle("WBF Forgot Password");
            ...
            public void onClick(View v) {
                ...
                fireBAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            fpMail.setText("");
                            Toast.makeText(wbf_forgot_password.this, "Password reset instructions sent", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Toast.makeText(wbf_forgot_password.this, "Failed to send email!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
